...
function Question() {
  ...
  return (
    <section id="questions" className="grid grid-cols-1 place-items-center w-full pt-30">
      ...
      <section className="w-50% my-5">
        {FAQ.map((faq, index) => (
          <div className="bg-brand-gray p-5 rounded-3 mb-4" key={index}>
            ...
            {expandedIndex === index && (
              <p className="text-4 leading-normal text-justify pt-2 text-gray-800">{faq.answer}</p>
            )}
          </div>
        ))}
      </section>
