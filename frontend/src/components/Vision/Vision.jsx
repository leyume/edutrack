  ...
  return (
    <div className="vision">
      <div className="vision-header">
        ...
        <p>
          Our comprehensive administrative management system provides schools, teachers and parents a flexible and efficiently streamline track operation over
          their school, students and children.
        </p>
      </div>
      <div className="vision-img-container">
        <div className="pic-1">
          <div className="site-txt">
            ...
            <p className="sch-ad-comment">Lorem ipsum dore helye sepum ipsum Lorem ipsum dore</p>
          </div>
          <div className="img-1">
