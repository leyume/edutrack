            ...
            <form action="" className="grid grid-cols-2 gap-4 w-full items-center">
                ...
                <div className="w-100%">
                    ...
                    <div className="flex justify-between my-4">
                        ...
                        <input type="radio" name="status" className="mr-2"/><label htmlFor="" className="mr-4">Active</label>
                        <input type="radio" name="status" className="mr-2"/><label htmlFor="">Inactive</label>
                        </div>
                    </div>
