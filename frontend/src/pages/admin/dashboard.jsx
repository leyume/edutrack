  ...
  return (
    <>
      <div className="text-center">
        <h1>SEEERRRRR</h1>
        <div className="flex items-center mx-auto justify-center border border-10 h-40 w-40 border-solid rounded-full border-black">
          <span className="i-tabler-school text-120px inline-block"></span>
        </div>
      </div>
            ...
            <div className="grid bg-#2375F0 w-3/5 h-40vh rounded-l-xl">
              <div>
                <div className="flex  text-white">
                  <h1 className="ml-6vh mt-16px font-900">Hello {data.firstname},</h1>
                ...
                <div className="ml-6vh text-white">
                  ...
                  <p className="mt-8 text-gray-400">{data.institution.location}.</p>
