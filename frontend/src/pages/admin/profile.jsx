  ...
  return (
    <>
      ...
      <section className="flex gap-5vh">
        <div className="grid items-center justify-items-center bg-#F41E922B w-486px h-509px mb-50px mt-8vh ml-8vh rounded-2">
        ...
        <div className="grid bg-#2375F0 w-486px h-509px mb-200px mt-8vh rounded-2">
