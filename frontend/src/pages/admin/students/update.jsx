    ...
    <main className="flex items-center flex-col px-10% mb-10">
      ...
      <form action="" className="grid grid-cols-2 gap-4 w-full items-center">
        <div className="w-100%">
          ...
          <label htmlFor="">Guardian First Name</label>
          <br />
          <input type="text" className="my-input" value="Nicholas" disabled />
          <br />
          <br />

          <label htmlFor="">Guardian Relationship</label>
          <br />
          <input type="text" className="my-input" value="Father" disabled />
          <br />
          <br />
        </div>
        ...
        <div className="w-100%">
          ...
          <br />
          <input type="text" className="my-input" value="Egesionu" disabled />
          <br />
          <br />
          ...
          <label htmlFor="">Guardian Last Name</label>
          <br />
          <input type="text" className="my-input" value="Egesionu" disabled />
          <br />
          <br />
