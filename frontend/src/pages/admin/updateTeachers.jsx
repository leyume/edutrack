            ...
            <form action="" className="grid grid-cols-2 gap-4 w-full items-center">
                ...
                <div className="w-100%">
                    ...
                    <div className="flex justify-between my-4">
                        ...
                        <input type="radio" name="gender" className="mr-1" disabled/><label htmlFor="" className="mr-4">Male</label>
                        <input type="radio" name="gender" className="mr-1" checked/><label htmlFor="" >Female</label>
                        </div>
                        <div>
