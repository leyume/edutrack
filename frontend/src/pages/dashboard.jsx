...
function Dashboard() {
  return (
    <div className="flex bg-#fff">
      <div className="bg-#E5E2EA w-20% p-30px">
        <Link to="/" className="text-brand-pink text-4xl font-bold">
          Edu<span className="text-brand-blue">Track</span>
        </Link>
        <nav className="[&>ul>li:hover]:bg-#2375F0 [&>ul>li>:hover]:text-#fff mt-30px text-black">
          <ul className="list-none">
            <li className="w-80% rounded-2 p-15px">
      ...
      <div className="bg-#fff w-80%">
        <div className="flex items-center justify-end gap-20px mt-20px mr-8 mb-6">
