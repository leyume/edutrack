        ...
        <section className="flex items-center flex-col bg-#F8EFE2 px-5 py-5  my-5 rounded-2">
          ...
          >
            <div className="w-100%">
              ...
              <br />
              <input type="text" className="my-input" value="Ann" disabled />
              <br />
              <br />
            ...
            <div className="w-100%">
              ...
              <br />
              <input type="text" className="my-input" value="Philip" disabled />
              <br />
              <br />

              <label htmlFor="">Class</label>
              <br />
              <input type="text" className="my-input" value="SS 3" disabled />
              <br />
              <br />
